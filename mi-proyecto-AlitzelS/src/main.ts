 ...
 * Definimos la estructura exacta de la tabla que vemos en tu imagen. Tabla Uusuario
 */
interface Usuario {
  idusuario: number;     
  nombre: string;         
 ...
 * Esta función entra a la base de datos y trae los usuarios.
 */
const getUsuario = async (): Promise<void> => {
  ...
  // Usamos 'as Usuario[]' para decirle a TS que confíe en nuestra interfaz.
